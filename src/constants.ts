...
export const systemsData: SystemsDataStructure = {
    ...
    arcade: {
        ...
        'sega-arcade': {
          label: 'SEGA',
          systems: ['Sega Classique', 'Sega G80', 'System 1', 'System 2', 'System E', 'System C', 'System C-2', 'System 16', 'System 18', 'System 24', 'System 32', 'Sega Mega PlayS', 'X Board', 'Y Board', 'ST-V', 'Europa-R', 'System SP', 'Model 1', 'Model 2', 'Model 3', 'Hikaru', 'Naomi', 'Naomi 2', 'Chihiro', 'Lindbergh', 'RingEdge', 'RingEdge 2', 'RingWide', 'ALLS']
        },
        namco: { label: 'NAMCO', systems: ['Namco Classique', 'Namco System', 'Namco System 1', 'Namco System 2', 'Namco System 2x6', 'Namco System 10', 'Namco System 11', 'Namco System 12', 'Namco System 21', 'Namco System 22', 'Namco System 23', 'Namco System 357', 'Namco System 369', 'Namco System ES1', 'Namco System ES2', 'Namco System ES3', 'Namco System FL', 'Namco System NA-1', 'Namco System NA-2', 'Namco System NB-1', 'Namco System NB-2'] },
        konami: { label: 'KONAMI', systems: ['Konami Classics', 'Konami', 'Konami Bubble System', 'Konami GX', 'Konami GTI', 'Konami M2', 'Konami Hornet', 'Konami Python', 'Konami Viper', 'Konami Firebeat', 'Konami Twinkle', 'Konami Windy', 'Konami Windy X2', 'Konami System 573', 'Bemani DJ Main', 'Bemani PC', 'e-Amusement'] },
        ...
        fuuki: { label: 'FUUKI', systems: ['Fuuki'] },
        kaneko: { label: 'KANEKO', systems: ['Kaneko'] },
        seta: { label: 'SETA', systems: ['Seta', 'Aleck64'] },
        technos: { label: 'TECHNOS', systems: ['Technos'] },
        sunsoft: { label: 'SUNSOFT', systems: ['Sunsoft'] },
        ...
        allumer: { label: 'ALLUMER', systems: ['Allumer'] },
        success: { label: 'SUCCESS', systems: ['Success'] },
        suna: { label: 'SUNA', systems: ['Suna'] },
        yunsung: { label: 'YUN SUNG', systems: ['Yun Sung'] },
        bally: { label: 'BALLY', systems: ['Bally Classics'] },
        banpresto: { label: 'BANPRESTO', systems: ['Banpresto'] },
        atlus: { label: 'ATLUS', systems: ['Atlus'] },
    ...
    ordinosaure: {
        ...
        bandai: { label: 'BANDAI', systems: ['RX-78'] },
        ...
        casio: { label: 'CASIO', systems: ['PV-2000'] },
        ...
        exidy: { label: 'EXIDY', systems: ['Sorcerer'] },
